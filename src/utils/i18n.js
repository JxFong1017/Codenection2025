...
const DICTS = {
  en: {
    ...
    hero_subtitle: 'Get instant coverage, transparent pricing and hassle-free claims — all in one place.',
    ...
    terms_accept: 'I have read, understood and accepted the terms and conditions of the platform.',
    forgot_password: 'Forgot your password?',
    confirmation_instructions: 'Didn\'t receive confirmation instructions?',
    
    // Features
    secure: 'SECURE',
    secure_desc: 'Your data and policies are protected with enterprise-grade security.',
    fast: 'FAST',
    fast_desc: 'Quick claims and instant coverage so you spend less time waiting.',
    compare: 'COMPARE',
    compare_desc: 'Easily compare plans to find the best value for your car insurance.',
    
    // Insurance products
    insurance_products: 'Insurance Products',
    insurance_products_subtitle: 'Explore our variety of car insurance products tailored for you.',
    ...
    contact_us_help: 'If you have any questions, please do not hesitate to contact us.',
    back: 'Back',
    next: 'Next',
    submit: 'Submit',
    done: 'Done',
    ...
    find_best_coverage: 'Find the best coverage that fits your need and budget.',
    get_quote: 'Get Quote',
    reminder: 'Reminder',
    ...
    chat_no_answer: 'I couldn\'t find an exact answer. You can start a new quote at Get Quotation or go to /manual-quote for the 6-step flow. Would you like quick links?',
  ...
  ms: {
    ...
    hero_subtitle: 'Dapatkan perlindungan segera, harga telus dan tuntutan tanpa masalah — semuanya dalam satu tempat.',
    ...
    terms_accept: 'Saya telah membaca, memahami dan menerima terma dan syarat platform.',
    forgot_password: 'Lupa kata laluan anda?',
    confirmation_instructions: 'Tidak menerima arahan pengesahan?',
    
    // Features
    secure: 'SELAMAT',
    secure_desc: 'Data dan polisi anda dilindungi dengan keselamatan gred perusahaan.',
    fast: 'CEPAT',
    fast_desc: 'Tuntutan pantas dan perlindungan segera supaya anda menghabiskan masa menunggu yang lebih sedikit.',
    compare: 'BANDINGKAN',
    compare_desc: 'Dengan mudah bandingkan pelan untuk mencari nilai terbaik untuk insurans kereta anda.',
    
    // Insurance products
    insurance_products: 'Produk Insurans',
    insurance_products_subtitle: 'Terokai pelbagai produk insurans kereta yang disesuaikan untuk anda.',
    ...
    customer_reviews_subtitle: 'Lihat apa yang pelanggan kami katakan tentang kami!',
    ...
    contact_us_help: 'Jika anda mempunyai sebarang soalan, jangan teragak-agak untuk menghubungi kami.',
    back: 'Kembali',
    next: 'Seterusnya',
    submit: 'Hantar',
    done: 'Selesai',
    ...
    find_best_coverage: 'Cari perlindungan terbaik yang sesuai dengan keperluan dan bajet anda.',
    ...
    chat_no_answer: 'Saya tidak dapat mencari jawapan yang tepat. Anda boleh memulakan sebut harga baru di Dapatkan Sebut Harga atau pergi ke /manual-quote untuk aliran 6 langkah. Adakah anda mahu pautan pantas?',
  ...
  zh: {
    ...
    chat_no_answer: '我找不到确切的答案。您可以在获取报价处开始新报价，或前往/manual-quote进行6步流程。您需要快速链接吗？',
